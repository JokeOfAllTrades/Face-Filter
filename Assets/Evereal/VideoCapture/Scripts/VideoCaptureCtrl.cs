  ...
  public class VideoCaptureCtrl : VideoCaptureCtrlBase
  {
    ...
    public AudioCapture audioCapture
    {
      ...
      set
      {
        ...
        {
          Debug.LogWarning("[VideoCaptureCtrl::AudioCapture] Cannot set aduio during capture session!");
          return;
        }
        _audioCapture = value;
      }
    ...
    public override void StartCapture()
    {
      ...
      {
        Debug.LogWarning("[VideoCaptureCtrl::StartCapture] Previous capture not finish yet!");
        return;
      }
      ...
      {
        Debug.LogError(
            "[VideoCaptureCtrl::StartCapture] StartCapture called but no attached VideoRecorder or AudioRecorder were found!"
        );
        return;
      }
      ...
      {
        Debug.LogError(
            "[VideoCaptureCtrl::StartCapture] FFmpeg not found, please follow document and add ffmpeg executable before start capture!"
        );
        return;
      }
