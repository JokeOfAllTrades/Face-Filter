 ...
 *
 * Member classes: `BaseCascadeClassifier`, `CascadeClassifier`, `HOGDescriptor`, `QRCodeDetector`, `FaceDetectorYN`, `FaceRecognizerSF`
 *
 * Member enums: `HistogramNormType`, `DescriptorStorageFormat`, `ObjectStatus`, `DisType`
 */
